...
class Embedding_based(nn.Module):
    ...
    def calc_cf_loss(self, user_ids, item_pos_ids, item_neg_ids):
        ...
        item_pos_cf_embed = inject_embedding(item_pos_embed, item_pos_kg_embed)         # (cf_batch_size, embed_dim)
        item_neg_cf_embed = inject_embedding(item_neg_embed, item_neg_kg_embed)         # (cf_batch_size, embed_dim)
    ...
    def calc_score(self, user_ids, item_ids):
        ...
        item_cf_embed = inject_embedding(item_embed, item_kg_embed)                     # (n_items, embed_dim)
